...
const MovieDetailes = () => {
  ...
  return info ? (
    <div
      ...
      className="w-screen h-[160vh] px-[10%] overflow-hidden"
    >
      {/* //part 2 */}
      ...
      <div className="w-full flex gap-20">
        ...
        <div className="detiasl">
          ...
          <h1 className="text-sm my-3 font-semibold text-white">Overviwe</h1>
          ...
          <div className="w-[600px] text-zinc-200 text-sm flex flex-wrap mb-5">
            ...
            <Link className="rounded bg-[#6556CD] px-4 py-2 text-white" to={`${pathname}/trailer`}> <i class="ri-play-fill"></i> Play Trailer</Link>
        </div>
      </div>
      ...
      <hr className="mt-5"/>
      <h1 className="text-2xl font-semibold text-white my-5">Recommendation & Similer Stuff</h1>
