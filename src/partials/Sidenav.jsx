...
const Sidenav = () => {
  ...
  return (
    <div className="sidebar  w-[20%] h-full border-r-2 border-zinc-600 p-5">
      ...
      <nav className="flex flex-col text-zinc-400 text-lg gap-5">
        ...
        <Link to={`/populer`} className="hover:bg-[#6556CD] px-2 rounded-sm hover:text-white py-1">
          <i className="mr-2 ri-bard-fill"></i>
          Popular
        </Link>
        <Link to={`/movie`} className="hover:bg-[#6556CD] px-2 rounded-sm hover:text-white py-1">
          <i className="mr-2 ri-movie-2-fill"></i>
          Movies
        </Link>
        <Link to={`/tv`} className="hover:bg-[#6556CD] px-2 rounded-sm hover:text-white py-1">
          <i className="mr-2 ri-tv-fill"></i>
          Tv Shows
        </Link>
        <Link to={`/person`} className="hover:bg-[#6556CD] px-2 rounded-sm hover:text-white py-1">
      ...
      <div className="websiteinfo flex flex-col text-zinc-400 gap-4">
